...
const experiences = [
  {
    ...
    current: true,
    achievements: [
      "Built and maintained responsive web applications using React.js, TypeScript, and Tailwind CSS",
      "Developed a full-stack CRM system to manage client workflows and automate business processes",
      "Designed and implemented scalable REST APIs using Node.js",
      "Collaborated with cross-functional teams on UI/UX and feature development",
      "Debugged and optimized applications for performance and stability",
    ],
  ...
  },
  {
    ...
    current: false,
    achievements: [
      "Performed manual testing for a mobile application built using Flutter",
      "Identified bugs and ensured application reliability across multiple devices",
